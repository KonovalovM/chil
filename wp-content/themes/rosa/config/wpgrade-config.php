		...
		'register'                => array(
			'head-scripts'   => array(
				...
				'webfont-script'       => array(
					'path'    => 'https://ajax.googleapis.com/ajax/libs/webfont/1.5.3/webfont.js',
					'require' => array(
						'jquery'
					),
				),
			...
			'footer-scripts' => array(
				...
				'google-maps-api'      => array(
					'path'    => 'https://maps.google.com/maps/api/js?sensor=false&amp;language=en',
					'require' => array(
						'jquery'
					),
				),
			...
			'styles'         => array(
				'google-webfonts'    => array(
					'path' => 'https://fonts.googleapis.com/css?family=Source+Sans+Pro:400,700,900|Cabin:400,700,400italic,700italic|Herr+Von+Muellerhoff',
				),
