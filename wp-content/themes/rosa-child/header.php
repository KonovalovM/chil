...
<div class="page_loader_wrapper" style="display:none;">
	<div class="loader_logo"><img class="site-logo-img--light" src="<?php echo wpgrade::image_src( 'main_logo_light' ); ?>" <?php echo $data_retina_logo_light; ?> rel="logo" alt="<?php echo get_bloginfo( 'name' ) ?>" style="width:100%;max-width:400px;"/></div>
								...
								<li class="shop-menu-item  menu-item-has-children">
									<div class="widget_shopping_cart_content">
										...
										<ul class="sub-menu">
											...
											<li>
												<a href="<?php echo $woocommerce->cart->get_cart_url(); ?>"><?php _e( 'View cart', 'rosa_txtd' ) ?></a>
											</li>
											<li>
												<a href="<?php echo $woocommerce->cart->get_checkout_url() ?>"><?php _e( 'Checkout', 'rosa_txtd' ) ?></a>
											</li>
										</ul>
									</div>
								</li>
