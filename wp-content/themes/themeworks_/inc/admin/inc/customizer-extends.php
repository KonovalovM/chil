...
if ( class_exists( 'WP_Customize_Control' ) ) {
     ...
     */
    class themeworks_Multi_Image_Control extends WP_Customize_Control {
        ...
        public function enqueue() {
            wp_enqueue_media();
            wp_enqueue_script( 'mutli-image-control', get_template_directory_uri() . '/inc/admin/js/multi-image.js', array('jquery', 'jquery-ui-sortable'), '', true );
        }
        ...
        public function theButtons() { ?>
            <div>
                ...
                <a href="#" class="button-secondary multi-images-remove" data-store="#<?php echo $this->inputId; ?>" data-thumbs-container="#<?php echo $this->thumbnailsId; ?>">
                   <?php _e( 'Remove Images', 'themeworks'); ?>
               </a>
           </div>
           <?php
       }
