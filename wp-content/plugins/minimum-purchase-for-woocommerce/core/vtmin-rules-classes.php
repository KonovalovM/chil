...
class VTMIN_Rule {
 ...
 //    public  $inpop_group_is_based_on;  //prodcat / rulecat / role / multi / null
     ...
     //v1.09.91.2 beg
     //if this switch = 'yes', then the rule triggering population must be in the cart.
     // two ways to fail this rule
     // 1. rule triggering population not in cart
     // 2. rule triggering population does not meet requirement
     public  $rule_pop_must_be_in_cart;
     //v1.09.91.2 end     
     ...
     *********************    */
     ...
     public  $at_least_one_product_found;  //v1.09.91.2     
     //******************************************
  ...
  //    $this->inpop_group_is_based_on;
     ...
     $this->rule_pop_must_be_in_cart;  //v1.09.91.2 end 
     ...
     */
     ...
     $this->inpop_found_list = array(
      ...
      $this->at_least_one_product_found;  //v1.09.91.2
