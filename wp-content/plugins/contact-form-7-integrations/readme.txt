...
Tested up to: 4.2.3
Donate link:
Tags: Contact Form 7, Contact 7 Database, Contact Form 7 Analytics, zapier, Contact Form Database, Contact Form 7 CRM, Contact Form 7 Extension, Contact Form 7 Integration, Contact Form, CRM, Database, cf7
...
This plugin Integrates Contact Form 7 with a cloud-based contact management database, CRM Tools, form conversion analytics and hundreds [3rd party software integrations including ZAPIER](http://help.contactus.com/hc/en-us/articles/200918046-Installing-the-CF7-Integrations-Plugin "Contact Form 7 available Integrations instructions"). Supported and maintained by ContactUs.com
...
= 1.4.1 =
* FIX: Quick links for easy software integrations (3rd-Party Integrations) has been fixed
* *Launch date 29.07.2015*

= 1.4 =
* FIX: Updated integration process with latest contact-form-7 add-on requirements
* New: UI improvements
* Upgrade: TGM Plugin Activation Library to latest version
* General Bug Fixes
...
= 1.4.1 =
New version available, bugs fixed, update NOW!
